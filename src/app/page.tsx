          ...
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            <div className="pt-4 max-w-2xl mx-auto">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm shadow-md transition-all shrink-0"
                >
